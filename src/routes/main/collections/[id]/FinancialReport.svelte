...
<div class={`fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm ${open ? 'block' : 'hidden'}`}>
	<div class="w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-lg bg-gray-900 p-6">
