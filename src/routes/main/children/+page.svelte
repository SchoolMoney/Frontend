...
async function fetchClasses() {
  ...
  function getChildName(class_id: number): string {
  ...
  function handleChildCancelClick() {
    selectedChildId = 0;
    fetchUserChildren();
  }
        ...
        {/if}
          ...
          <Card class="h-full transition-shadow hover:shadow-md">
            <CardHeader>
              ...
              <CardDescription>Birth date: {child.birth_date}<br/>Child: {getChildName(child.group_id)}</CardDescription>
            </CardHeader>
